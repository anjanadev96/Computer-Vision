...
def CounterForSquares(input_file, output_file):
    ...
    while (cap.isOpened()):
        ...
        if ret == True:
            ...
            str1="Cyan = " + str(count_cyan)
            str2="Yellow = "+str(count_yellow)
            str3="Green = "+str(count_green)
            str4="Blue = "+str(count_blue)
            str5="Red = "+str(count_red)
            str6="Orange = "+str(count_orange)
            str7="Purple = "+str(count_purple)

            cv2.putText(frame,str1,(20, 50),fontFace=cv2.FONT_HERSHEY_SIMPLEX,fontScale=1, color=(255, 255, 255))
            cv2.putText(frame,str2,(20, 100), fontFace=cv2.FONT_HERSHEY_SIMPLEX, fontScale=1,color=(255, 255, 255))
            cv2.putText(frame,str3,(20, 150), fontFace=cv2.FONT_HERSHEY_SIMPLEX, fontScale=1,color=(255, 255, 255))
            cv2.putText(frame, str4, (20, 200), fontFace=cv2.FONT_HERSHEY_SIMPLEX, fontScale=1,
                        color=(255, 255, 255))
            cv2.putText(frame, str5, (20, 250), fontFace=cv2.FONT_HERSHEY_SIMPLEX, fontScale=1,
                        color=(255, 255, 255))
            cv2.putText(frame, str6, (20, 300), fontFace=cv2.FONT_HERSHEY_SIMPLEX, fontScale=1,
                        color=(255, 255, 255))
            cv2.putText(frame, str7, (20, 350), fontFace=cv2.FONT_HERSHEY_SIMPLEX, fontScale=1,
                        color=(255, 255, 255))
