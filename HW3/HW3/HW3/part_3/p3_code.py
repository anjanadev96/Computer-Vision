...
def NoOfLinesRemoved(input_file, output_file):
    ...
    while (cap.isOpened()):
        ...
        if ret == True:
            ...
            cv2.putText(frame, str1, (20, 50), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 0), 2, cv2.LINE_AA)
...
NoOfLinesRemoved('p3_tetris_1.mp4','p3_tetris_1_output.avi')
#NoOfLinesRemoved('p3_tetris_2.mp4', 'p3_tetris_2_output.avi')
